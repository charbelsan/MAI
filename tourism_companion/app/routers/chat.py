...
from app.chains import main_chain, search_nearby, create_tourist_circuit, analyze_request, get_message
import os
import base64
import tempfile
...
async def chat(request: ChatRequest, db: Session = Depends(get_db)):
    ...
    if request.text:
        ...
        action_flag = analyze_request(transcription)
   ...
   # Store messages in conversation memory
    conversation_memory.save_context({"input": transcription}, {"output": response})
